...
- **Ask** — conversation list and transcript, server-owned messages, streamed answers, document-level sources with complete or partial read coverage, a live answer process retained on the latest answer, knowledge-base selection, and durable V1/V2 document clarification with ranked candidates, bounded filename refinement, and broad fallback.
