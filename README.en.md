...
- **Ask** — conversation list and transcript, server-owned messages, streamed answers, citations beside answers, knowledge-base selection, and collapsed evidence and activity history.
