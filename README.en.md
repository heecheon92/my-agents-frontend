...
- **Ask** — conversation list and transcript, server-owned messages, streamed answers, document-level sources with complete or partial read coverage, a live answer process retained on the latest answer, and knowledge-base selection.
