...
Frontend workaround, if any: Documentation and product copy are aligned now; runtime model/client changes remain gated on the backend-hosted OpenAPI document.
